                ...
                <div className="flex flex-col w-full max-w-4xl bg-white shadow-2xl rounded-2xl md:flex-row">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex items-center justify-center">
                                <button
                                    type="submit"
                                    disabled={loading} 
                                    className={`relative inline-flex items-center justify-center px-6 py-2 overflow-hidden text-base text-white transition-all duration-300 ease-in-out ${loading ? 'bg-gray-400' : 'bg-blue-500'} border rounded-md font-medium group/button backdrop-blur-lg hover:scale-110 hover:shadow-xl hover:shadow-blue-600/50 border-white/20`}
                                >
                    ...
                    <div className="relative flex flex-col items-center justify-center w-full rounded-b-lg md:w-1/2 bg-gradient-to-br md:rounded-r-lg md:rounded-bl-none">
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center px-6 text-white">
                            <h1 className="text-3xl font-semibold">សូមស្វាគមន៍!</h1>
                            <p className="mt-2 text-lg text-center">
                                ការផ្តល់សេវាដែលល្អបំផុតសម្រាប់ការគ្រប់គ្រងកុំព្យូទ័រ។
                            </p>
                            <div className="flex justify-center mt-4">
                                <FaGoogle className="mr-4 text-3xl cursor-pointer" />
