            ...
            <form onSubmit={handleFormSubmit} className="space-y-6 p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-semibold text-gray-800">ទីតាំង</label>
        ...
        <div className="relative">
              ...
              <div className="md:hidden sticky top-[75px]">
                ...
                >
                  ...
                  <svg className="w-4 h-4 ml-2 animate-bounce text-blue-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <div className="mt-1 ml-3 bg-white border w-48 border-gray-300  rounded-lg flex justify-center">
                    <div className="py-2 px-2 font-normal">
                      <button
