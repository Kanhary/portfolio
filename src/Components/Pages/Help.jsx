      ...
      <div className="p-8 mx-auto bg-white shadow-xl rounded-2xl">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            <div className="p-6 transition-shadow duration-300 bg-white border border-gray-300 rounded-lg shadow-md hover:shadow-lg">
              ...
              <p className="text-gray-600">
                To reset your password, go to the <Link to="/main-dashboard/setting" className="font-medium text-blue-800">Settings Page</Link> and follow the instructions to reset your password.
              </p>
            </div>
        ...
        <section>
          <div className='sm:px-6 lg:px-8'>
            <div className='grid grid-cols-1 lg:grid-cols-2'>
              ...
              <div>
                <form className='p-5 bg-gray-50 lg:p-11 lg:rounded-r-2xl rounded-2xl' onSubmit={handleSubmit}>
                  <h2 className='text-4xl font-semibold leading-10 text-indigo-600 font-manrope mb-11'>Send Us A Messange If You Need Help</h2>
                  <div>
                  ...
                  <button className="w-full h-12 mt-2 text-base font-semibold leading-6 text-white transition-all duration-700 bg-indigo-600 rounded-full shadow-sm hover:bg-indigo-800">Send</button>
                </form>
              </div>
            </div>
          </div>
