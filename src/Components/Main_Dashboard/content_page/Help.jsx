...
const Help = () => {
  return (
    <div className="min-h-screen p-8 text-gray-800 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 dark:text-gray-200">
      <header className="mb-12 text-center">
        <h1 className="mb-4 text-2xl font-extrabold text-gray-900 dark:text-gray-100">Help Center</h1>
        <p className="text-xl text-gray-600 dark:text-gray-300">
          Find guidance and support to make the most of our application.
        </p>
      </header>

      <main className="max-w-4xl mx-auto overflow-hidden bg-white shadow-lg dark:bg-gray-900 rounded-2xl">
        ...
        <section className="p-6">
          <div className="pb-4 mb-6 border-b border-gray-200 dark:border-gray-700">
            <h3 className="mb-2 text-3xl font-semibold text-gray-900 dark:text-gray-100">Overview</h3>
            ...
            <ul className="pl-5 text-gray-700 list-disc dark:text-gray-300">
          ...
          <div className="pb-4 mb-6 border-b border-gray-200 dark:border-gray-700">
            <h3 className="mb-2 text-3xl font-semibold text-gray-900 dark:text-gray-100">Troubleshooting</h3>
            <ul className="pl-5 text-gray-700 list-disc dark:text-gray-300">
          ...
          <div>
            <h3 className="mb-2 text-3xl font-semibold text-gray-900 dark:text-gray-100">Frequently Asked Questions</h3>
            <ul className="pl-5 text-gray-700 list-disc dark:text-gray-300">
