            ...
            <table className='w-full text-sm text-left text-gray-500'>
              <thead className='text-xs text-gray-700 uppercase bg-gray-50'>
                <tr>
                  ...
                  <th scope='col' className='px-4 py-3' style={{ minWidth: '150px' }}>Nickname</th>
                  ...
                  <th scope='col' className='px-4 py-3' style={{ minWidth: '150px' }}>Gender</th>
                  <th scope='col' className='px-4 py-3' style={{ minWidth: '150px' }}>Staff Code</th>
                  <th scope='col' className='px-4 py-3' style={{ minWidth: '150px '}}>Avatar</th>
                  <th scope="col" className="px-4 py-3" style={{ minWidth: '150px' }}>Status</th>
                  <th scope="col" className="px-4 py-3" style={{ minWidth: '150px' }}>Creater</th>
                  <th scope="col" className="px-4 py-3" style={{ minWidth: '150px' }}>Create Time</th>
                  <th scope="col" className="px-4 py-3" style={{ minWidth: '150px' }}>Updater</th>
                  <th scope="col" className="px-4 py-3" style={{ minWidth: '150px' }}>Update Time</th>
                </tr>
              </thead>
              <tbody>
                {currentPageUsers.map(user => (
                  <tr key={`${user.userCode}-${user.userName}`} className='border-b'>
                    ...
                    <td className='px-4 py-3'>{user.creator}</td>
                    <td className='px-4 py-3'>{user.create_time}</td>
                    <td className='px-4 py-3'>{user.updater}</td>
                    <td className='px-4 py-3'>{user.update_time}</td>
                  </tr>
                ))}
              </tbody>
